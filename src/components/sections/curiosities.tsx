...
import { Code2, Coffee, Music, Gamepad2, BookOpen, Laptop, BadgeCheck } from "lucide-react";
	...
	return (
		<section className="py-12 md:py-16 lg:py-20 bg-background relative overflow-hidden">
			<div className="container mx-auto px-4 md:px-6">
				...
				<div className="grid lg:grid-cols-[1fr_auto_1fr] gap-4 md:gap-6 items-start max-w-7xl mx-auto">
					{/* Cards de Curiosidades */}
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-3 md:gap-4 order-2 lg:order-1">
					...
					>
						<div className="space-y-6">
							...
							<p className="text-muted-foreground leading-relaxed">
								Adicione seu texto aqui. Este espaço está reservado para você incluir informações adicionais, descrições ou qualquer conteúdo que desejar exibir ao lado do seu perfil.
							</p>
							<p className="text-muted-foreground leading-relaxed">
								Você pode adicionar múltiplos parágrafos, listas ou qualquer outro conteúdo relevante.
							</p>
						</div>
					</motion.div>
				</div>
