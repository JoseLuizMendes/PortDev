...
export default function CurriculoPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="max-w-[210mm] mx-auto bg-white shadow-2xl shadow-black/50 print:shadow-none my-8 print:my-0">
        <div className="p-12 print:p-8">
          {/* Cabeçalho */}
          <header className="text-center mb-8 pb-6 border-b-2 border-gray-300">
            <h1 className="text-4xl font-bold text-gray-900 mb-2">JOSÉ LUIZ DOS SANTOS AZEREDO MENDES</h1>
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-700">
              ...
              <span>josemendess004@gmail.com</span>
            </div>
          </header>

          {/* Objetivo Profissional */}
          <section className="mb-6">
            <h3 className="text-2xl font-bold text-gray-900 mb-3 border-b border-gray-300 pb-2">
              OBJETIVO PROFISSIONAL
            </h3>
          ...
          <section className="mb-6">
            ...
            <div className="mb-3">
              <h4 className="text-lg font-semibold text-gray-900">Ciência da Computação</h4>
              <p className="text-gray-600 text-sm">FAESA - Cursando 4º período (noturno)</p>
            </div>
          </section>
          ...
          <section className="mb-6">
            ...
            <div className="mb-4">
              <div className="flex justify-between items-start mb-2">
                <div>
                  <h4 className="text-lg font-semibold text-gray-900">Estagiário - PRODEST</h4>
                  <p className="text-gray-600 text-sm">Processamento de Dados do Espírito Santo</p>
                </div>
                <span className="text-gray-500 text-sm">Out/2024 - Atual</span>
              </div>
          ...
          <section className="mb-6">
            ...
            <div className="mb-4">
              <h4 className="text-lg font-semibold text-gray-900">SaaS – Sistema de Agendamento para Barbearias</h4>
            ...
            <div className="mb-4">
              <h4 className="text-lg font-semibold text-gray-900">API em Java/Spring Boot</h4>
              <p className="text-gray-600 text-sm mb-2">
            ...
            <div className="mb-3">
              <h4 className="text-lg font-semibold text-gray-900">Desafios Técnicos – Itaú e PicPay</h4>
              <p className="text-gray-600 text-sm mb-2">
          ...
          <section className="mb-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                <h4 className="font-semibold text-gray-900 mb-2 text-sm">Linguagens</h4>
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-2 text-sm">Ferramentas</h4>
                <ul className="list-disc list-inside text-gray-700 text-sm space-y-1">
